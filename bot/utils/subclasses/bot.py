    ...
    async def __ainit__(self):
        await self.db.execute(
            r"""CREATE TABLE IF NOT EXISTS prefixes     (guild_id BIGINT NOT NULL, prefixes TEXT[] DEFAULT '{}');
                ...
                CREATE TABLE IF NOT EXISTS reminders    (reminder_id SERIAL, owner_id BIGINT NOT NULL, channel_id BIGINT NOT NULL, hour INT, minute INT, second INT, reason TEXT NOT NULL);
